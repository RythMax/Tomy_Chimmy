...
namespace Tomy_Chimy.Web.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ID_Orden"] = new SelectList(_context.Orders, "ID_Orden", "ID_Orden");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailID,ID_Comidas,CantidadDeArticulos,ValorUnitario,ValorTotal,ID_Orden")] OrderDetail orderDetail)
        {
            ...
            ViewData["ID_Comidas"] = new SelectList(_context.Comidas, "ID_Comidas", "Descripción", orderDetail.ID_Comidas);
            ViewData["ID_Orden"] = new SelectList(_context.Orders, "ID_Orden", "ID_Orden", orderDetail.ID_Orden);
